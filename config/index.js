export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wxce0fbed9c4f09caf",

  // 公众号APP_SECRET 
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "3c1d141a23818ab8197ae3ea9110fe3c",
  ...
  USERS: [
    {
      ...
      name: "老婆",
      // 扫码关注你的微信测试号后生成的一段字符串，在测试号后台能看到
      id: "or8jH6AVqsYBmw592gahKCrOxhsc",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "b7PSCFLSVZsXh4B6tOOmsNa62r4F_XJTCZRAjQB3a2s",
      // 所在省份
      province: "河南",
      // 所在城市
      city: "信阳",
  ...
  CALLBACK_TEMPLATE_ID: "faS3Gu2uUYdXsVRbLyOXt637gJAPUvBv4InGegmRDlA",
